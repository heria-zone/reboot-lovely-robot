...
public class AiAutoAttackGoal<T extends LivingEntity> extends NearestAttackableTargetGoal {
    ...
    // -- Constructors --
    public AiAutoAttackGoal(RobotEntity mob, Class<T> p_26061_, boolean p_26062_) {
        this(mob, p_26061_, 10, p_26062_, false, (Predicate<LivingEntity>)null);
        entity = mob;
    } // Constructor AiAutoAttackGoal ()

    public AiAutoAttackGoal(RobotEntity mob, Class<T> p_199892_, boolean p_199893_, Predicate<LivingEntity> p_199894_) {
        this(mob, p_199892_, 10, p_199893_, false, p_199894_);
        entity = mob;
    } // Constructor AiAutoAttackGoal ()

    public AiAutoAttackGoal(RobotEntity mob, Class<T> p_26065_, boolean p_26066_, boolean p_26067_) {
        this(mob, p_26065_, 10, p_26066_, p_26067_, (Predicate<LivingEntity>)null);
        entity = mob;
    } // Constructor AiAutoAttackGoal ()

    public AiAutoAttackGoal(RobotEntity mob, Class<T> targetClass, int p_26055_, boolean p_26056_, boolean p_26057_, @Nullable Predicate<LivingEntity> p_26058_) {
