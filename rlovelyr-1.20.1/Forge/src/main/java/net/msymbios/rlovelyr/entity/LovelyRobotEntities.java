...
public class LovelyRobotEntities {
    ...
    public static final RegistryObject<EntityType<BunnyEntity>> BUNNY = register(LovelyRobotID.BUNNY, MobCategory.CREATURE, InternalMetric.WIDTH, InternalMetric.HEIGHT, BunnyEntity::new);
    public static final RegistryObject<EntityType<Bunny2Entity>> BUNNY2 = register(LovelyRobotID.BUNNY2, MobCategory.CREATURE, InternalMetric.WIDTH, InternalMetric.HEIGHT, Bunny2Entity::new);
    public static final RegistryObject<EntityType<DragonEntity>> DRAGON = register(LovelyRobotID.DRAGON, MobCategory.CREATURE, InternalMetric.WIDTH, InternalMetric.HEIGHT, DragonEntity::new);
    public static final RegistryObject<EntityType<HoneyEntity>> HONEY = register(LovelyRobotID.HONEY, MobCategory.CREATURE, InternalMetric.WIDTH, InternalMetric.HEIGHT, HoneyEntity::new);
    public static final RegistryObject<EntityType<KitsuneEntity>> KITSUNE = register(LovelyRobotID.KITSUNE, MobCategory.CREATURE, InternalMetric.WIDTH, InternalMetric.HEIGHT, KitsuneEntity::new);
    public static final RegistryObject<EntityType<NekoEntity>> NEKO = register(LovelyRobotID.NEKO, MobCategory.CREATURE, InternalMetric.WIDTH, InternalMetric.HEIGHT, NekoEntity::new);
    public static final RegistryObject<EntityType<VanillaEntity>> VANILLA = register(LovelyRobotID.VANILLA, MobCategory.CREATURE, InternalMetric.WIDTH, InternalMetric.HEIGHT, VanillaEntity::new);
