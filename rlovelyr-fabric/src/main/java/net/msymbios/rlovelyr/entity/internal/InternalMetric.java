...
public class InternalMetric {
    ...
    public static HashMap<EntityTexture, List<EntityVariant>> ENTITY_TEXTURE = new HashMap(){{
        List<EntityVariant> list = new ArrayList<EntityVariant>() {{
            add(EntityVariant.Bunny);
            add(EntityVariant.Bunny2);
            add(EntityVariant.Honey);
            add(EntityVariant.Vanilla);
        }};
        put(EntityTexture.BLUE, new ArrayList<EntityVariant>() {{
            add(EntityVariant.Bunny);
            add(EntityVariant.Bunny2);
            add(EntityVariant.Honey);
            add(EntityVariant.Vanilla);
        ...
        put(EntityTexture.LIME, new ArrayList<EntityVariant>() {{
            add(EntityVariant.Bunny);
            add(EntityVariant.Bunny2);
            add(EntityVariant.Honey);
            add(EntityVariant.Vanilla);
        ...
        put(EntityTexture.LIGHT_BLUE, new ArrayList<EntityVariant>() {{
            add(EntityVariant.Bunny);
            add(EntityVariant.Bunny2);
            add(EntityVariant.Honey);
            add(EntityVariant.Vanilla);
        ...
        put(EntityTexture.LIGHT_GRAY, new ArrayList<EntityVariant>() {{
            add(EntityVariant.Bunny);
            add(EntityVariant.Bunny2);
            add(EntityVariant.Honey);
            add(EntityVariant.Vanilla);
        ...
        put(EntityTexture.ORANGE, new ArrayList<EntityVariant>() {{
            add(EntityVariant.Bunny);
            add(EntityVariant.Bunny2);
            add(EntityVariant.Honey);
            add(EntityVariant.Vanilla);
        ...
        put(EntityTexture.PURPLE, new ArrayList<EntityVariant>() {{
            add(EntityVariant.Bunny);
            add(EntityVariant.Bunny2);
            add(EntityVariant.Honey);
            add(EntityVariant.Vanilla);
        ...
        put(EntityTexture.RED, new ArrayList<EntityVariant>() {{
            add(EntityVariant.Bunny);
            add(EntityVariant.Bunny2);
            add(EntityVariant.Honey);
            add(EntityVariant.Vanilla);
        ...
        put(EntityTexture.YELLOW, new ArrayList<EntityVariant>() {{
            add(EntityVariant.Bunny);
            add(EntityVariant.Bunny2);
            add(EntityVariant.Honey);
            add(EntityVariant.Vanilla);
    ...
    public static HashMap<EntityAnimator, Identifier> ANIMATOR = new HashMap() {{
        put(EntityAnimator.Default,    new Identifier(LovelyRobotMod.MODID, "animations/lovelyrobot.animation.json"));
    }};
