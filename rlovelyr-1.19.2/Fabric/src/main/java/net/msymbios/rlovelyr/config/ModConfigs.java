...
public class ModConfigs {
    ...
    private static void createConfigs() {
        ...
        // GENERAL
        CONFIG.addKeyValuePair(new Pair<>("general.movement-melee-attack", 0.8F), "Movement speed when it is melee attacking | Float");
        CONFIG.addKeyValuePair(new Pair<>("general.movement-follow-owner", 0.7F), "Movement speed when following player | Float");
        CONFIG.addKeyValuePair(new Pair<>("general.movement-wander-around", 0.6F),"Movement speed while it is wandering around | Float");
        ...
        CONFIG.addKeyValuePair(new Pair<>("entity.bunny.movement-speed", 0.6F),         "Movement Speed | Float");
        ...
        CONFIG.addKeyValuePair(new Pair<>("entity.bunny2.movement-speed", 0.6F),         "Movement Speed | Float");
        ...
        CONFIG.addKeyValuePair(new Pair<>("entity.dragon.attack-damage", 7F),            "Attack Damage | Float");
        CONFIG.addKeyValuePair(new Pair<>("entity.dragon.attack-speed", 1.2F),           "Attack Speed | Float");
        CONFIG.addKeyValuePair(new Pair<>("entity.dragon.defence", 7F),                  "Defence | Float");
        CONFIG.addKeyValuePair(new Pair<>("entity.dragon.movement-speed", 0.6F),         "Movement Speed | Float");
        ...
        CONFIG.addKeyValuePair(new Pair<>("entity.kitsune.movement-speed", 0.6F),         "Movement Speed | Float");
        ...
        CONFIG.addKeyValuePair(new Pair<>("entity.neko.movement-speed", 0.6F),         "Movement Speed | Float");
        ...
        CONFIG.addKeyValuePair(new Pair<>("entity.vanilla.movement-speed", 0.6F),         "Movement Speed | Float");
    ...
    private static void assignConfigs() {
        // GENERAL
        InternalMetrics.MOVEMENT_MELEE_ATTACK = CONSTRUCTOR.getOrDefault("general.movement-melee-attack", 0.8F);
        InternalMetrics.MOVEMENT_FOLLOW_OWNER = CONSTRUCTOR.getOrDefault("general.movement-follow-owner", 0.7F);
        InternalMetrics.MOVEMENT_WANDER_AROUND = CONSTRUCTOR.getOrDefault("general.movement-wander-around", 0.6F);
        ...
        InternalMetrics.BUNNY_MOVEMENT_SPEED = CONSTRUCTOR.getOrDefault("entity.bunny.movement-speed", 0.6F);
        ...
        InternalMetrics.BUNNY2_MOVEMENT_SPEED = CONSTRUCTOR.getOrDefault("entity.bunny2.movement-speed", 0.6F);
        ...
        InternalMetrics.DRAGON_MOVEMENT_SPEED = CONSTRUCTOR.getOrDefault("entity.dragon.movement-speed", 0.6F);
        ...
        InternalMetrics.HONEY_MOVEMENT_SPEED = CONSTRUCTOR.getOrDefault("entity.honey.movement-speed", 0.6F);
        ...
        InternalMetrics.KITSUNE_MOVEMENT_SPEED = CONSTRUCTOR.getOrDefault("entity.kitsune.movement-speed", 0.6F);
        ...
        InternalMetrics.NEKO_MOVEMENT_SPEED = CONSTRUCTOR.getOrDefault("entity.neko.movement-speed", 0.6F);
        ...
        InternalMetrics.VANILLA_MOVEMENT_SPEED = CONSTRUCTOR.getOrDefault("entity.vanilla.movement-speed", 0.6F);
