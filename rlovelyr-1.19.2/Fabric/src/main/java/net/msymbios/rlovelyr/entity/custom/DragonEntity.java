...
public class DragonEntity extends InternalEntity implements IAnimatable {
    ...
    public static DefaultAttributeContainer.Builder setAttributes() {
        return MobEntity.createMobAttributes()
                .add(EntityAttributes.GENERIC_MAX_HEALTH, InternalMetrics.DRAGON_MAX_HEALTH)
                .add(EntityAttributes.GENERIC_ATTACK_DAMAGE, InternalMetrics.DRAGON_ATTACK_DAMAGE)
                .add(EntityAttributes.GENERIC_ATTACK_SPEED, InternalMetrics.DRAGON_ATTACK_SPEED)
                .add(EntityAttributes.GENERIC_MOVEMENT_SPEED, InternalMetrics.DRAGON_MOVEMENT_SPEED)
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(4, new AiBaseDefenseGoal(this, InternalMetrics.MOVEMENT_FOLLOW_OWNER, InternalMetrics.DRAGON_BASE_DEFENCE_RANGE, InternalMetrics.DRAGON_BASE_DEFENCE_WARP_RANGE));
