...
public class DragonEntity extends InternalEntity implements IAnimatable {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(4, new AiBaseDefenseGoal(this, ConfigMetric.MOVEMENT_FOLLOW_OWNER, ConfigMetric.DRAGON_BASE_DEFENCE_RANGE, ConfigMetric.DRAGON_BASE_DEFENCE_WARP_RANGE));
