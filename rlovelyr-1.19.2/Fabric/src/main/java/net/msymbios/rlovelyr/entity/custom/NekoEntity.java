...
public class NekoEntity extends InternalEntity implements IAnimatable {
    ...
    public static DefaultAttributeContainer.Builder setAttributes() {
        return MobEntity.createMobAttributes()
                .add(EntityAttributes.GENERIC_MAX_HEALTH, InternalMetrics.NEKO_MAX_HEALTH)
                .add(EntityAttributes.GENERIC_ATTACK_DAMAGE, InternalMetrics.NEKO_ATTACK_DAMAGE)
                .add(EntityAttributes.GENERIC_ATTACK_SPEED, InternalMetrics.NEKO_ATTACK_SPEED)
                .add(EntityAttributes.GENERIC_MOVEMENT_SPEED, InternalMetrics.NEKO_MOVEMENT_SPEED)
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(4, new AiBaseDefenseGoal(this, InternalMetrics.MOVEMENT_FOLLOW_OWNER, InternalMetrics.NEKO_BASE_DEFENCE_RANGE, InternalMetrics.NEKO_BASE_DEFENCE_WARP_RANGE));
