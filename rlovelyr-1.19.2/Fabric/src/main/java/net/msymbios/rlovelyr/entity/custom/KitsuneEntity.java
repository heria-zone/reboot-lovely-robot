...
public class KitsuneEntity extends InternalEntity implements IAnimatable {
    ...
    public static DefaultAttributeContainer.Builder setAttributes() {
        return MobEntity.createMobAttributes()
                .add(EntityAttributes.GENERIC_MAX_HEALTH, InternalMetrics.KITSUNE_MAX_HEALTH)
                .add(EntityAttributes.GENERIC_ATTACK_DAMAGE, InternalMetrics.KITSUNE_ATTACK_DAMAGE)
                .add(EntityAttributes.GENERIC_ATTACK_SPEED, InternalMetrics.KITSUNE_ATTACK_SPEED)
                .add(EntityAttributes.GENERIC_MOVEMENT_SPEED, InternalMetrics.KITSUNE_MOVEMENT_SPEED)
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(4, new AiBaseDefenseGoal(this, InternalMetrics.MOVEMENT_FOLLOW_OWNER, InternalMetrics.KITSUNE_BASE_DEFENCE_RANGE, InternalMetrics.KITSUNE_BASE_DEFENCE_WARP_RANGE));
