...
public class VanillaEntity extends InternalEntity implements IAnimatable {
    ...
    public static DefaultAttributeContainer.Builder setAttributes() {
        return MobEntity.createMobAttributes()
                .add(EntityAttributes.GENERIC_MAX_HEALTH, InternalMetrics.VANILLA_MAX_HEALTH)
                .add(EntityAttributes.GENERIC_ATTACK_DAMAGE, InternalMetrics.VANILLA_ATTACK_DAMAGE)
                .add(EntityAttributes.GENERIC_ATTACK_SPEED, InternalMetrics.VANILLA_ATTACK_SPEED)
                .add(EntityAttributes.GENERIC_MOVEMENT_SPEED, InternalMetrics.VANILLA_MOVEMENT_SPEED)
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(4, new AiBaseDefenseGoal(this, InternalMetrics.MOVEMENT_FOLLOW_OWNER, InternalMetrics.VANILLA_BASE_DEFENCE_RANGE, InternalMetrics.VANILLA_BASE_DEFENCE_WARP_RANGE));
        ...
        this.targetSelector.add(4, new AiAutoAttackGoal(this, MobEntity.class, InternalMetrics.ATTACK_CHANCE, false, false, InternalMetric.AvoidAttackingEntities));
