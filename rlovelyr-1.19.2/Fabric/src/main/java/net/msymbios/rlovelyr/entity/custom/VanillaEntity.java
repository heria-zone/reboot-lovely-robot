...
public class VanillaEntity extends InternalEntity implements IAnimatable {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(4, new AiBaseDefenseGoal(this, ConfigMetric.MOVEMENT_FOLLOW_OWNER, ConfigMetric.VANILLA_BASE_DEFENCE_RANGE, ConfigMetric.VANILLA_BASE_DEFENCE_WARP_RANGE));
