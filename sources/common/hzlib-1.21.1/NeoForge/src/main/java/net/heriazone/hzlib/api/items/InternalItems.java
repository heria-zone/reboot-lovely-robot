...
public class InternalItems {
     ...
     */
    protected static DeferredHolder<Item, Item> register(DeferredRegister<Item> register, ResourceLocation name, Item item) {
     ...
     */
    protected static DeferredHolder<Item, Item> register(DeferredRegister<Item> register, ResourceLocation name, Block block) {
