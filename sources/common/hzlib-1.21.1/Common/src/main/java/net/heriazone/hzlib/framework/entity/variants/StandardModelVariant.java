...
/**
 * <p>Standard model variant implementation using path templates.<p>
 * <p>
 * <b>Architecture:</b> Provides template-based model path generation with placeholder
 * substitution for entity keys and variant names. Enables consistent model organization
 ...
 * <p>
 * <b>Use Cases:</b> Standard entity models following conventional naming patterns
 * like "geo/{entity}.geo.json" or "geo/{entity}.{variant}.geo.json".
 */
public class StandardModelVariant implements IModelVariant {
    ...
    /**
     * Creates standard model variant with specified parameters.
     * <p>
     * <b>Path Template Format:</b> Use {entity} for entity key substitution and
     * {variant} for variant key substitution. Example: "geo/{entity}.{variant}.geo.json"
     *
     ...
     */
    public StandardModelVariant(String key, String displayName, String pathTemplate, int priority) {
    ...
    } // Constructor: StandardModelVariant ()

    /**
     * Creates standard model variant with default priority (0).
     *
     * @param key unique identifier for this variant
     * @param displayName human-readable name for display
     * @param pathTemplate path template with {entity} and {variant} placeholders
     */
    public StandardModelVariant(String key, String displayName, String pathTemplate) {
    ...
    public boolean equals(Object obj) {
        ...
        StandardModelVariant that = (StandardModelVariant) obj;
