 ...
 */
public abstract class BaseAnimationController<T extends InternalEntity> {
     ...
     * @param <E> entity type extending InternalEntity
     * @return GeckoLib PlayState for animation controller
     */
    public static <E extends InternalEntity> Object handleAttackAnimation(E animatable, Object state) {
     ...
     * @return GeckoLib PlayState for animation controller
     */
    public static <E extends InternalEntity> Object handleLocomotionAnimation(E entity, Object state) {
