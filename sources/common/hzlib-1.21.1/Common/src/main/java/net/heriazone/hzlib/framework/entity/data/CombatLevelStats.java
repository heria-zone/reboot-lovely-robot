...
public class CombatLevelStats {
     ...
     */
    public CombatLevelStats() {
        this(0, 0, 20, 20, 5, 5);
    } // Constructor: CombatLevelStats ()
     ...
     */
    public CombatLevelStats(int level, int experience, int currentHp, int maxHp, int attack, int defense) {
        this.level = level;
     ...
     *
     * @return new CombatLevelStats instance with copied values
     */
    public CombatLevelStats copy() {
        return new CombatLevelStats(level, experience, currentHp, maxHp, attack, defense);
    } // copy ()

    @Override
    public String toString() {
        return "CombatLevelStats {" +
                "level=" + level +
                ", exp=" + experience +
                ", hp=" + currentHp + "/" + maxHp +
                ", atk=" + attack +
