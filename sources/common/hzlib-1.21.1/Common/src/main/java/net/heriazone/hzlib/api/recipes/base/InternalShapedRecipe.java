package net.heriazone.hzlib.api.recipes.base;
...
/**
 * Base class for shaped recipes that craft items with full data transfer.
 * <p>
 ...
 * <p>
 * <b>Data Behavior:</b> Copies ALL custom data from one item to another.
 * <p>
 ...
 */
public abstract class InternalShapedRecipe extends ShapedRecipe {
    ...
    public InternalShapedRecipe(String group, CraftingBookCategory category,
    ...
    } // Constructor: InternalShapedRecipe()
