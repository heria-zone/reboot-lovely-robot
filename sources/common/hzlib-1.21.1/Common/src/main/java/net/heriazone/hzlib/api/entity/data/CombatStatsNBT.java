...
/**
 * <p>Handles NBT serialization for CombatLevelStats with version-aware migration support.</p>
 * <p>
 ...
 * on CombatLevelStats maintains framework layer purity (zero Minecraft dependencies).
 * <p>
...
public class CombatStatsNBT implements IReadWriteNBT {
     ...
     */
    public CombatStatsNBT(@NotNull CombatLevelStats stats) {
        this.stats = Objects.requireNonNull(stats, "CombatLevelStats cannot be null");
    } // Constructor: CombatStatsNBT ()
     ...
     */
    @NotNull
    public CombatLevelStats getStats() {
        return stats;
    } // getStats ()
