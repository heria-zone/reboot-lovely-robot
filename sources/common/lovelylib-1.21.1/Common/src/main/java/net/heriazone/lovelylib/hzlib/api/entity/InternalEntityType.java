...
import net.heriazone.lovelylib.common.entity.enums.EntityVariantAnimator;
import net.heriazone.lovelylib.common.entity.enums.EntityVariantModel;
import net.heriazone.lovelylib.common.entity.enums.EntityVariantTexture;
...
public abstract class InternalEntityType<T extends InternalEntityType<T>> {
    ...
    protected final ResourceMap<EntityVariantTexture, ResourceLocation> textures;
    protected final ResourceMap<EntityVariantModel, ResourceLocation> models;
    protected final ResourceMap<EntityVariantAnimator, ResourceLocation> animators;
     ...
     */
    protected abstract void populateTextures(ResourceMap<EntityVariantTexture, ResourceLocation> textures);
     ...
     */
    protected abstract void populateModels(ResourceMap<EntityVariantModel, ResourceLocation> models);
     ...
     */
    protected abstract void populateAnimators(ResourceMap<EntityVariantAnimator, ResourceLocation> animators);
     ...
     */
    public ResourceMap<EntityVariantTexture, ResourceLocation> getTextures() {
        return textures;
    } // getTextures ()
     ...
     */
    public ResourceMap<EntityVariantModel, ResourceLocation> getModels() {
        return models;
    } // getModels ()
     ...
     */
    public ResourceMap<EntityVariantAnimator, ResourceLocation> getAnimators() {
        return animators;
    } // getAnimators ()
