...
public class AiBaseDefenseGoal extends Goal {
    ...
    public void start() {
        ...
        this.oldWaterPathfindingPenalty = this.entity.getPathfindingMalus(PathType.WATER);
    ...
    public void stop() {
        ...
        this.entity.setPathfindingMalus(PathType.WATER, this.oldWaterPathfindingPenalty);
    ...
    private void executeScanPattern() {
        ...
        // Apply rotation step
        float rotationStep = (float) SharedConfigs.Common.GuardRotationSpeed;
    ...
    private void setRandomStateDuration() {
        ...
        switch (currentDefenseState) {
            case PATROL:
                durationMin = SharedConfigs.Common.PatrolDurationMin;
                durationMax = SharedConfigs.Common.PatrolDurationMax;
                break;
            case GUARD:
                durationMin = SharedConfigs.Common.GuardDurationMin;
                durationMax = SharedConfigs.Common.GuardDurationMax;
                break;
            default:
                durationMin = 600;
                durationMax = 900;
    ...
    private boolean canTeleportTo(BlockPos pos) {
        PathType pathNodeType = WalkNodeEvaluator.getPathTypeStatic(this.entity, pos);
