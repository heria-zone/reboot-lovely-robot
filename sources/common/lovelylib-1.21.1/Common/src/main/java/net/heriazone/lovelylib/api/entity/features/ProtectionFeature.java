...
public class ProtectionFeature {
    ...
    private IProtectionCalculationStrategy strategy;
     ...
     */
    public ProtectionFeature(IProtectionCalculationStrategy strategy) {
    ...
    } // canUpgradeProjectileProtection ()
    ...
    } // calculateAutoProjectileProtection ()
     ...
     * @throws NullPointerException if strategy is null
     */
    public void setStrategy(IProtectionCalculationStrategy strategy) {
        this.strategy = Objects.requireNonNull(strategy, "ProtectionCalculationStrategy cannot be null");
    } // setStrategy ()
     ...
     */
    public IProtectionCalculationStrategy getStrategy() {
        return strategy;
    } // getStrategy ()
