...
public record LayerRenderContext(
     ...
     */
    public static LayerRenderContext texture(ResourceLocation texture, LovelyRobotEntity entity) {
     ...
     */
    public static LayerRenderContext coloredTexture(ResourceLocation texture, int color, LovelyRobotEntity entity) {
     ...
     */
    public static LayerRenderContext transparentTexture(ResourceLocation texture, float alpha, LovelyRobotEntity entity) {
     ...
     */
    public static LayerRenderContext conditionalTexture(ResourceLocation texture, Supplier<Boolean> condition, LovelyRobotEntity entity) {
     ...
     */
    public LovelyRobotEntity getEntity() {
        return entity;
    } // getEntity()
