...
/**
 * <p>NeoForge entry point for Template mod.<p>
 * <p>
...
public class TemplateMod {
     ...
     */
    public TemplateMod(IEventBus modEventBus) {
        LOGGER.info("Constructing Template Mod for NeoForge");
        
        // Register setup event
        modEventBus.addListener(this::onCommonSetup);
        
        LOGGER.info("Template Mod NeoForge constructor complete");
    }
    ...
    private void onCommonSetup(final FMLCommonSetupEvent event) {
        LOGGER.info("Template Mod NeoForge common setup starting");
        ...
        LOGGER.info("Template Mod NeoForge common setup complete");
    }
