...
/**
 * Configuration system for Reboot variant (NeoForge loader).
 * <p>
 ...
 */
@EventBusSubscriber(modid = Reboot.MODID, bus = EventBusSubscriber.Bus.MOD)
public class RebootConfigs {
    ...
    private static int getDefaultIntValue(String variant, String configType) {
        SharedConfigs.EntityConfigData data = net.heriazone.lovelylib.source.reboot.RebootConfigs.getDefaultConfig(variant);
        return switch (configType) {
    ...
    public static void register(ModContainer modContainer) {
        modContainer.registerConfig(ModConfig.Type.COMMON, RebootConfigs.SPEC);
    } // register ()
    ...
    static void onLoad(final ModConfigEvent event) {
        //Reboot.LOGGER.info("Loading configuration from: {}", event.getConfig().getFileName());
    ...
    public static void reload() {
        //Reboot.LOGGER.info("Reloading configuration...");
        ...
        //Reboot.LOGGER.info("Configuration reload requested - Forge will handle reload on next config change");
    } // reload()
