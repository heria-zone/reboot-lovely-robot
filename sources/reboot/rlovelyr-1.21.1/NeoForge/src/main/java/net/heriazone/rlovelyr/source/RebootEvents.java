...
public class RebootEvents {
     ...
     */
    @EventBusSubscriber(modid = Reboot.MODID, bus = EventBusSubscriber.Bus.GAME)
     ...
     * gameplay events).
     */
    @EventBusSubscriber(modid = Reboot.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.DEDICATED_SERVER)
     ...
     */
    @EventBusSubscriber(modid = Reboot.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
