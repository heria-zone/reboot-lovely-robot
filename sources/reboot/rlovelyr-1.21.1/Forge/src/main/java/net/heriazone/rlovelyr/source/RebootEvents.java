...
public class RebootEvents {
     ...
     */
    @Mod.EventBusSubscriber(modid = Reboot.MODID, bus = Mod.EventBusSubscriber.Bus.FORGE)
     ...
     * gameplay events).
     */
    @Mod.EventBusSubscriber(modid = Reboot.MODID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.DEDICATED_SERVER)
    public static class ServerEvents {
        ...
        public void onServerStarting(ServerStartingEvent event) {
            Reboot.LOGGER.info("HELLO FROM SERVER: STARTING");
        } // onServerStarting()
     ...
     */
    @Mod.EventBusSubscriber(modid = Reboot.MODID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
    public static class ClientEvents {
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            RebootItems.registerModel(event);
        } // onClientSetup()
        ...
        public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
            RebootEntities.registerRender(event);
        } // registerRenderers()
