package net.msymbios.rlovelyr.source.groups;
...
public class DefaultItemsGroup {
    ...
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, LovelyReboot.MODID);
