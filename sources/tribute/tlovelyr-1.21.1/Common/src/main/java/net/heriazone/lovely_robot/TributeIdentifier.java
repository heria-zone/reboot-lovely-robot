...
public class TributeIdentifier extends InternalIdentifier {

    // -- Variables --

    private static final TributeIdentifier INSTANCE = new TributeIdentifier();

    // -- Inherited Methods --

    @Override
    protected String getModId() {
        return Tribute.MODID;
    } // getModId ()
