...
public class Tribute {
     ...
     */
    public static final String MODID = "lovely_robot";
    
    /**
     * Mod display name for user-facing contexts.
     */
    public static final String MOD_NAME = "Lovely Tribute";
    ...
    public static void init() {
        ...
        LOGGER.info("Initializing {} - Faithful recreation of the original LovelyRobot mod", MOD_NAME);
