...
public class TributeItems extends InternalItems {
    ...
    // SPAWNS
    public static final Item BUNNY_SPAWN = registerItem(LovelyConstant.BUNNY_SPAWN, TributeEntities.BUNNY, Rarity.RARE, 1);
    public static final Item BUNNY2_SPAWN = registerItem(LovelyConstant.BUNNY2_SPAWN, TributeEntities.BUNNY2, Rarity.RARE, 1);
    public static final Item HONEY_SPAWN = registerItem(LovelyConstant.HONEY_SPAWN, TributeEntities.HONEY, Rarity.RARE, 1);
    public static final Item VANILLA_SPAWN = registerItem(LovelyConstant.VANILLA_SPAWN, TributeEntities.VANILLA, Rarity.RARE, 1);
