...
public class TributeRecipes {
    ...
    public static final DeferredRegister<RecipeSerializer<?>> RECIPE_SERIALIZERS = DeferredRegister.create(ForgeRegistries.RECIPE_SERIALIZERS, TributeIdentifier.MODID());

    // -- Recipe Serializers --

    public static final RegistryObject<TributeSpawnRecipeSerializer> SPAWN_EGG_CRAFTING = RECIPE_SERIALIZERS.register("lovely_spawn", () -> new TributeSpawnRecipeSerializer(TributeItems.ROBOT_CORE.get()));
    public static final RegistryObject<TributeSpawnDyeRecipeSerializer> SPAWN_EGG_DYE = RECIPE_SERIALIZERS.register("lovely_spawn_dye", TributeSpawnDyeRecipeSerializer::new);
