...
public class TributeEvents {
     ...
     */
    @Mod.EventBusSubscriber(modid = Tribute.MODID, bus = Mod.EventBusSubscriber.Bus.FORGE)
    public static class ForgeEvents {
        ...
        public static void onRegisterCommands(RegisterCommandsEvent event) {
            ...
            Tribute.LOGGER.info("Registered LovelyRobotEntity commands");
        } // onRegisterCommands()
     ...
     * gameplay events).
     */
    @Mod.EventBusSubscriber(modid = Tribute.MODID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.DEDICATED_SERVER)
    public static class ServerEvents {
        ...
        public void onServerStarting(ServerStartingEvent event) {
            Tribute.LOGGER.info("HELLO FROM SERVER: STARTING");
        } // onServerStarting()
     ...
     */
    @Mod.EventBusSubscriber(modid = Tribute.MODID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
    public static class ClientEvents {
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            TributeItems.registerModel(event);
        } // onClientSetup()
        ...
        public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
            TributeEntities.registerRender(event);
        } // registerRenderers()
