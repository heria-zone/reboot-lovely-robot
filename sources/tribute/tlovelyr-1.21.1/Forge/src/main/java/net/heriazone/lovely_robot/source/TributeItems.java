...
public class TributeItems extends InternalItems {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, Tribute.MODID);

    // MISCELLANEOUS
    public static final RegistryObject<Item> ROBOT_CORE = registerItem(LovelyConstant.ROBOT_CORE, Rarity.UNCOMMON, 1);

    // SPAWNS
    public static final RegistryObject<Item> BUNNY_SPAWN   = registerItem(RobotVariant.Bunny.getName()   + "_spawn", TributeEntities.BUNNY::get,   Rarity.RARE, 1);
    public static final RegistryObject<Item> BUNNY2_SPAWN  = registerItem(RobotVariant.Bunny2.getName()  + "_spawn", TributeEntities.BUNNY2::get,  Rarity.RARE, 1);
    public static final RegistryObject<Item> HONEY_SPAWN   = registerItem(RobotVariant.Honey.getName()   + "_spawn", TributeEntities.HONEY::get,   Rarity.RARE, 1);
    public static final RegistryObject<Item> VANILLA_SPAWN = registerItem(RobotVariant.Vanilla.getName() + "_spawn", TributeEntities.VANILLA::get, Rarity.RARE, 1);
