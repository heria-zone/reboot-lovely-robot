...
public class TributeItems extends InternalItems {
    ...
    // SPAWNS
    public static final RegistryObject<Item> BUNNY_SPAWN = registerItem(LovelyConstant.BUNNY_SPAWN, TributeEntities.BUNNY::get, Rarity.RARE, 1);
    public static final RegistryObject<Item> BUNNY2_SPAWN = registerItem(LovelyConstant.BUNNY2_SPAWN, TributeEntities.BUNNY2::get, Rarity.RARE, 1);
    public static final RegistryObject<Item> HONEY_SPAWN = registerItem(LovelyConstant.HONEY_SPAWN, TributeEntities.HONEY::get, Rarity.RARE, 1);
    public static final RegistryObject<Item> VANILLA_SPAWN = registerItem(LovelyConstant.VANILLA_SPAWN, TributeEntities.VANILLA::get, Rarity.RARE, 1);
