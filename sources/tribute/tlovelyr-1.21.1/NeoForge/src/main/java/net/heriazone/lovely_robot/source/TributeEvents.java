...
public class TributeEvents {
     ...
     */
    @EventBusSubscriber(modid = Tribute.MODID, bus = EventBusSubscriber.Bus.GAME)
     ...
     * gameplay events).
     */
    @EventBusSubscriber(modid = Tribute.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.DEDICATED_SERVER)
     ...
     */
    @EventBusSubscriber(modid = Tribute.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
