 ...
 */
public class TributeCommandArguments {
    ...
    public static final DeferredRegister<ArgumentTypeInfo<?, ?>> COMMAND_ARGUMENT_TYPES =
            DeferredRegister.create(Registries.COMMAND_ARGUMENT_TYPE, Tribute.MODID);
     ...
     */
    public static final DeferredHolder<ArgumentTypeInfo<?, ?>, ArgumentTypeInfo<?, ?>> COLOR_ARGUMENT_TYPE = COMMAND_ARGUMENT_TYPES.register("color", ColorArgumentTypeInfo::new);
    ...
    public static void register (IEventBus events) {
        ...
        Tribute.LOGGER.info("Registering Command Arguments: " + Tribute.MODID);
    } // register ()
    ...
    public static void register (FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            Tribute.LOGGER.info("Registered ColorArgumentType");
        });
    } // register ()

} // Class: TributeCommandArguments