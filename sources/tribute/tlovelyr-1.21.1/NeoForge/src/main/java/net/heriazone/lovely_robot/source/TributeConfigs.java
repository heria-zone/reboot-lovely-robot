...
/**
 * Configuration system for Tribute variant (NeoForge loader).
 * <p>
 ...
 */
@EventBusSubscriber(modid = Tribute.MODID, bus = EventBusSubscriber.Bus.MOD)
public class TributeConfigs {
    ...
    private static int getDefaultIntValue(String variant, String configType) {
        SharedConfigs.EntityConfigData data = net.heriazone.lovelylib.source.tribute.TributeConfigs.getDefaultConfig(variant);
        return switch (configType) {
    ...
    public static void register(ModContainer modContainer) {
        modContainer.registerConfig(ModConfig.Type.COMMON, TributeConfigs.SPEC);
    } // register ()
    ...
    static void onLoad(final ModConfigEvent event) {
        //Tribute.LOGGER.info("Loading configuration from: {}", event.getConfig().getFileName());
        ...
        // Populate TributeConfigs.Entities HashMap using ConfigAccessLayer
        net.heriazone.lovelylib.source.tribute.TributeConfigs.Entities.clear();
        for (String variant : LovelyConstant.TRIBUTE_VARIANTS) {
            SharedConfigs.EntityConfigData entityConfig = ConfigAccessLayer.getEntityConfig(variant);
            net.heriazone.lovelylib.source.tribute.TributeConfigs.Entities.put(variant, entityConfig);
        }
    ...
    public static void reload() {
        //Tribute.LOGGER.info("Reloading configuration...");
        ...
        //Tribute.LOGGER.info("Configuration reload requested - Forge will handle reload on next config change");
    } // reload()
