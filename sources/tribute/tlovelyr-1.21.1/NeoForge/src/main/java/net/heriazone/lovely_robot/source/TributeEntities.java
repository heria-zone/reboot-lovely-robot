...
public class TributeEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<TributeRobotEntity>> BUNNY   = registerRobot(RobotVariant.Bunny.getName(),   TributeRobotFamilies.BUNNY);
    public static final DeferredHolder<EntityType<?>, EntityType<TributeRobotEntity>> BUNNY2  = registerRobot(RobotVariant.Bunny2.getName(),  TributeRobotFamilies.BUNNY2);
    public static final DeferredHolder<EntityType<?>, EntityType<TributeRobotEntity>> HONEY   = registerRobot(RobotVariant.Honey.getName(),   TributeRobotFamilies.HONEY);
    public static final DeferredHolder<EntityType<?>, EntityType<TributeRobotEntity>> VANILLA = registerRobot(RobotVariant.Vanilla.getName(), TributeRobotFamilies.VANILLA);
