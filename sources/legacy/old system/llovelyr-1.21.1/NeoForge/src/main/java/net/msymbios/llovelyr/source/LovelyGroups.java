...
/**
 * Manages creative mode tabs for Legacy variant items (NeoForge).
 * <p>
...
public class LovelyGroups extends InternalGroups {
    ...
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = createRegister(LovelyConstant.MODID);
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> DEFAULT_TAB = CREATIVE_MODE_TABS.register(
            LovelyIdentifier.DEFAULT_TAB,
            () -> createTabBuilder(
                    LovelyIdentifier.getTabTranslation(LovelyIdentifier.DEFAULT_TAB),
    ...
    public static void register(IEventBus eventBus) {
        ...
        LovelyConstant.LOGGER.info("Registering CreativeTabs: " + LovelyConstant.MODID);
    } // register()
