...
/**
 * NeoForge spawn egg for summoning robots with component-stored customization.
 * <p>
 ...
 * common behavior while maintaining NeoForge-specific inheritance requirements.
...
public class LovelySpawnItem extends DeferredSpawnEggItem {
    ...
    /**
     * Delegate class that extends BaseSpawnItem to provide NeoForge-specific implementations.
     * <p>
     ...
     */
    private class BaseSpawnItemDelegate extends net.msymbios.llovelyr.lib.items.base.BaseSpawnItem {
        ...
        @Override
        protected net.minecraft.world.phys.BlockHitResult getPlayerPOVHitResult(Level level, Player player, 
                                                                               net.minecraft.world.level.ClipContext.Fluid fluidMode) {
