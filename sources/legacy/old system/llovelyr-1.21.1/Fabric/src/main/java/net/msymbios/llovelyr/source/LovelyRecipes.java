...
import net.msymbios.llovelyr.shared.recipe.*;
 ...
 * to break cyclical dependency with LovelyItems registry.
 */
public class LovelyRecipes {

    // -- Recipe Serializers --

    public static final RecipeSerializer<LovelySpawnRecipe> SPAWN_EGG_CRAFTING = Registry.register(
            BuiltInRegistries.RECIPE_SERIALIZER,
            LovelyIdentifier.getId("lovely_spawn"),
            new LovelySpawnRecipeSerializer(LovelyItems.ROBOT_CORE)
    );
    
    public static final RecipeSerializer<LovelySpawnDyeRecipe> SPAWN_EGG_DYE = Registry.register(
            BuiltInRegistries.RECIPE_SERIALIZER,
            LovelyIdentifier.getId("lovely_spawn_dye"),
            new LovelySpawnDyeRecipeSerializer()
    );
