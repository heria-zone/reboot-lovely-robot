...
public class RobotRegistryManager {
     ...
     */
    @Nonnull
    public static OwnerRobotRegistry getRegistry(@Nonnull ServerLevel level) {
     ...
     */
    public static void clearRegistry(@Nonnull String serverId) {
     ...
     * @throws NullPointerException if level is null
     */
    public static void clearRegistry(@Nonnull ServerLevel level) {
        Objects.requireNonNull(level, "ServerLevel cannot be null");
     ...
     */
    @Nonnull
    private static String getServerId(@Nonnull ServerLevel level) {
        try {
            // Get server directory path as unique identifier
            File serverDir = level.getServer().getServerDirectory();
