...
public class NativeEntityType extends InternalEntityType<NativeEntityType> {
    ...
    protected void populateTextures(ResourceMap<EntityVariantTexture, ResourceLocation> textures) {
        ...
        textures.put(EntityVariantTexture.DEFAULT,
                    new ResourceLocation(LovelyLegacy.MODID, basePath + "default.png"));
    }
    ...
    protected void populateModels(ResourceMap<EntityVariantModel, ResourceLocation> models) {
        models.put(EntityVariantModel.DEFAULT,
                  new ResourceLocation(LovelyLegacy.MODID, "geo/" + key + "." + LovelyIdentifier.MOD_DEFAULT + ".geo.json"));
        models.put(EntityVariantModel.ARMED,
                  new ResourceLocation(LovelyLegacy.MODID, "geo/" + key + "." + LovelyIdentifier.MOD_ARMED + ".geo.json"));
    }
    ...
    protected void populateAnimators(ResourceMap<EntityVariantAnimator, ResourceLocation> animators) {
        animators.put(EntityVariantAnimator.DEFAULT,
                     new ResourceLocation(LovelyLegacy.MODID, "animations/" + LovelyIdentifier.ANIM_DEFAULT + ".animation.json"));
    }
    ...
    protected MutableComponent createTranslation(String key) {
        return Component.translatable("entity." + LovelyLegacy.MODID + "." + key);
    }
        ...
        for (EntityTexture color : EntityTexture.values()) {
            if (color != EntityTexture.RANDOM) {
                ...
                colorTextures.put(color, 
                                new ResourceLocation(LovelyLegacy.MODID, 
