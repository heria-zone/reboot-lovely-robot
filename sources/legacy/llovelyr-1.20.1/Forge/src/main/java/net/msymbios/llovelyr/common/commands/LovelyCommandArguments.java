...
public class LovelyCommandArguments {
    ...
    public static final DeferredRegister<ArgumentTypeInfo<?, ?>> COMMAND_ARGUMENT_TYPES =
            DeferredRegister.create(Registries.COMMAND_ARGUMENT_TYPE, LovelyLegacy.MODID);
     ...
     */
    public static final RegistryObject<ArgumentTypeInfo<?, ?>> COLOR_ARGUMENT_TYPE = COMMAND_ARGUMENT_TYPES.register("color", () -> new ColorArgumentTypeInfo());
    ...
    public static void register (FMLCommonSetupEvent event) {
        ...
        event.enqueueWork(() -> {
            ...
            LovelyLegacy.LOGGER.info("Registered ColorArgumentType");
        });
    } // register ()
