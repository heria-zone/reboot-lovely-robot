...
public class NativeEntityType extends InternalEntityType<NativeEntityType> {
    ...
    private final Map<EntityTexture, Identifier> colorTextures;
     ...
     */
    @Override
    protected void populateTextures(ResourceMap<EntityVariantTexture, Identifier> textures) {
        String basePath = LovelyIdentifier.TEXTURE_ENTITY_PATH + key + "/";
        textures.put(EntityVariantTexture.DEFAULT,
                    Identifier.of(LovelyLegacy.MODID, basePath + "default.png"));
    }
     ...
     */
    @Override
    protected void populateModels(ResourceMap<EntityVariantModel, Identifier> models) {
        models.put(EntityVariantModel.DEFAULT,
                  Identifier.of(LovelyLegacy.MODID, "geo/" + key + "." + LovelyIdentifier.MOD_DEFAULT + ".geo.json"));
        models.put(EntityVariantModel.ARMED,
                  Identifier.of(LovelyLegacy.MODID, "geo/" + key + "." + LovelyIdentifier.MOD_ARMED + ".geo.json"));
    }
     ...
     */
    @Override
    protected void populateAnimators(ResourceMap<EntityVariantAnimator, Identifier> animators) {
        animators.put(EntityVariantAnimator.DEFAULT,
                     Identifier.of(LovelyLegacy.MODID, "animations/" + LovelyIdentifier.ANIM_DEFAULT + ".animation.json"));
    }
    ...
    protected MutableText createTranslation(String key) {
        return Text.translatable("entity." + LovelyLegacy.MODID + "." + key);
    }
        ...
        for (EntityTexture color : EntityTexture.values()) {
            if (color != EntityTexture.RANDOM) {
                ...
                colorTextures.put(color, 
                                Identifier.of(LovelyLegacy.MODID, 
