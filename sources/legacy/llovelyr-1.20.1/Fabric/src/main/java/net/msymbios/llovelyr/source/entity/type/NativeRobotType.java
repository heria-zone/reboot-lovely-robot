...
public class NativeRobotType {
    ...
    public static void reloadFromConfig() {
        ...
        BUNNY2.withCombatStats(LovelyConfigs.Common.Bunny2MaxHealth,
                        LovelyConfigs.Common.Bunny2AttackDamage,
                        LovelyConfigs.Common.Bunny2AttackSpeed,
                        LovelyConfigs.Common.Bunny2Armor,
                        LovelyConfigs.Common.Bunny2ArmorToughness,
                        0F,
        ...
        DRAGON.withCombatStats(LovelyConfigs.Common.DragonMaxHealth,
                        LovelyConfigs.Common.DragonAttackDamage,
                        LovelyConfigs.Common.DragonAttackSpeed,
                        LovelyConfigs.Common.DragonArmor,
                        LovelyConfigs.Common.DragonArmorToughness,
                        0F,
        ...
        KITSUNE.withCombatStats(LovelyConfigs.Common.KitsuneMaxHealth,
                        LovelyConfigs.Common.KitsuneAttackDamage,
                        LovelyConfigs.Common.KitsuneAttackSpeed,
                        LovelyConfigs.Common.KitsuneArmor,
                        LovelyConfigs.Common.KitsuneArmorToughness,
                        0F,
        ...
        VANILLA.withCombatStats(LovelyConfigs.Common.VanillaMaxHealth,
                        LovelyConfigs.Common.VanillaAttackDamage,
                        LovelyConfigs.Common.VanillaAttackSpeed,
                        LovelyConfigs.Common.VanillaArmor,
                        LovelyConfigs.Common.VanillaArmorToughness,
