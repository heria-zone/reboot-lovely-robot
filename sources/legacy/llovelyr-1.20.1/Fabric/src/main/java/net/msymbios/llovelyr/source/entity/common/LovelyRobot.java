...
public abstract class LovelyRobot extends InternalEntity implements GeoEntity {
    ...
    public int getMaxLevel() { 
        ...
        if (nativeEntity instanceof net.msymbios.llovelyr.common.entity.type.RobotEntityType) {
            return ((net.msymbios.llovelyr.common.entity.type.RobotEntityType) nativeEntity).getMaxLevel();
        }
        return 0;
    } // getMaxLevel ()
    ...
    public LovelyRobot(EntityType<? extends InternalEntity> entityType, World world, net.msymbios.llovelyr.common.entity.type.RobotEntityType robotEntityType) {
    ...
    private boolean hasLevelSystem() {
        ...
        RobotEntityType robotType = (RobotEntityType) nativeEntity;
