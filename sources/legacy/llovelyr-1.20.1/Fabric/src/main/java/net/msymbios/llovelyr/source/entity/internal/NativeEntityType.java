package net.msymbios.llovelyr.source.entity.internal;
...
import net.msymbios.llovelyr.source.entity.internal.enums.EntityAnimator;
import net.msymbios.llovelyr.source.entity.internal.enums.EntityModel;
...
public class NativeEntityType extends InternalEntityType<NativeEntityType> {
    ...
    static {
        ...
        BUNNY2.addCombat(
                LovelyConfigs.Common.Bunny2MaxLevel,
                LovelyConfigs.Common.Bunny2MaxHealth,
        ...
        VANILLA.addCombat(
                LovelyConfigs.Common.VanillaMaxLevel,
                LovelyConfigs.Common.VanillaMaxHealth,
     ...
     */
    private NativeEntityType(String key) {
        super(key);
