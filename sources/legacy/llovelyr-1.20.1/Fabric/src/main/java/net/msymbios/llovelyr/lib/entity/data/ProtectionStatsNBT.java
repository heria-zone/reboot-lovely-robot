...
public class ProtectionStatsNBT implements IReadWriteNBT {
     ...
     */
    public ProtectionStatsNBT(@NotNull ProtectionStats stats) {
    ...
    public NbtCompound writeToNBT(@NotNull NbtCompound tag) {
        Objects.requireNonNull(tag, "NbtCompound cannot be null");
    ...
    @Override
    public void readFromNBT(@NotNull NbtCompound tag, @NotNull Version tagVersion) {
        Objects.requireNonNull(tag, "NbtCompound cannot be null");
