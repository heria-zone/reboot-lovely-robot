...
public class LovelySpawnRecipeSerializer implements RecipeSerializer<LovelySpawnRecipe> {
    ...
    public LovelySpawnRecipe read(Identifier id, JsonObject json) {
        ...
        String[] pattern = IShapedRecipeAccessor.invokeRemovePadding(IShapedRecipeAccessor.invokeGetPattern(JsonHelper.getArray(json, "pattern")));
    ...
    @Override
    public LovelySpawnRecipe read(Identifier id, PacketByteBuf buf) {
    ...
    @Override
    public void write(PacketByteBuf buf, LovelySpawnRecipe recipe) {
