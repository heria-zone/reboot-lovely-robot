 ...
 * <p>
 * <b>Architecture:</b> Wraps Minecraft's ActiveTargetGoal with
 ...
 * HostileEntity.class for hostile mobs, PlayerEntity.class for PvP).
 *
 * @param <T> target entity type constraint
 */
public class AiAutoAttackGoal<T extends LivingEntity> extends ActiveTargetGoal<T> {
