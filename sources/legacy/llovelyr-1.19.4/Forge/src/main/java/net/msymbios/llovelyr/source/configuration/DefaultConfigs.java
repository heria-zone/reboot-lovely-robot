package net.msymbios.llovelyr.source.configuration;
...
public class DefaultConfigs {
    ...
    private static final ForgeConfigSpec.ConfigValue<List<? extends String>> ITEM_STRINGS = BUILDER
            ...
            .defineListAllowEmpty(Collections.singletonList("items"), () -> List.of("minecraft:iron_ingot"), DefaultConfigs::validateItemName);
