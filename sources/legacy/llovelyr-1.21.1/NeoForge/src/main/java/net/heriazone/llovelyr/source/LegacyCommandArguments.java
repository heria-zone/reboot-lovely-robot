 ...
 */
public class LegacyCommandArguments {
    ...
    public static final DeferredRegister<ArgumentTypeInfo<?, ?>> COMMAND_ARGUMENT_TYPES =
            DeferredRegister.create(Registries.COMMAND_ARGUMENT_TYPE, Legacy.MODID);
    ...
    public static void register (IEventBus events) {
        ...
        Legacy.LOGGER.info("Registering Command Arguments: " + Legacy.MODID);
    } // register ()
    ...
    public static void register (FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            Legacy.LOGGER.info("Registered ColorArgumentType");
        });
    } // register ()

} // Class: LegacyCommandArguments