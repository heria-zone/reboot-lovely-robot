...
import net.msymbios.llovelyr.shared.recipe.LovelySpawnDyeRecipeSerializer;
import net.msymbios.llovelyr.shared.recipe.LovelySpawnRecipeSerializer;
...
public class LovelyRecipes {
    ...
    public static final DeferredRegister<RecipeSerializer<?>> RECIPE_SERIALIZERS = DeferredRegister.create(BuiltInRegistries.RECIPE_SERIALIZER, LovelyIdentifier.MODID());

    // -- Recipe Serializers --
    
    public static final DeferredHolder<RecipeSerializer<?>, LovelySpawnRecipeSerializer> SPAWN_EGG_CRAFTING = RECIPE_SERIALIZERS.register("lovely_spawn", () -> new LovelySpawnRecipeSerializer(LovelyItems.ROBOT_CORE.get()));
    public static final DeferredHolder<RecipeSerializer<?>, LovelySpawnDyeRecipeSerializer> SPAWN_EGG_DYE = RECIPE_SERIALIZERS.register("lovely_spawn_dye", LovelySpawnDyeRecipeSerializer::new);
    ...
    public static void register(IEventBus events) {
        ...
        LovelyConstant.LOGGER.info("Registering Recipes: " + LovelyConstant.MODID);
    } // register()
