...
public class LovelyItems extends InternalItems {
    ...
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(LovelyConstant.MODID);

    // MISCELLANEOUS
    public static final DeferredItem<Item> ROBOT_CORE = registerItem(LovelyIdentifier.ROBOT_CORE, Rarity.UNCOMMON, 1);

    // SPAWNS
    public static final DeferredItem<Item> BUNNY_SPAWN = registerItem(LovelyIdentifier.BUNNY_SPAWN, LovelyEntities.BUNNY::get, Rarity.RARE, 1);
    public static final DeferredItem<Item> BUNNY2_SPAWN = registerItem(LovelyIdentifier.BUNNY2_SPAWN, LovelyEntities.BUNNY2::get, Rarity.RARE, 1);
    public static final DeferredItem<Item> DRAGON_SPAWN = registerItem(LovelyIdentifier.DRAGON_SPAWN, LovelyEntities.DRAGON::get, Rarity.RARE, 1);
    public static final DeferredItem<Item> HONEY_SPAWN = registerItem(LovelyIdentifier.HONEY_SPAWN, LovelyEntities.HONEY::get, Rarity.RARE, 1);
    public static final DeferredItem<Item> KITSUNE_SPAWN = registerItem(LovelyIdentifier.KITSUNE_SPAWN, LovelyEntities.KITSUNE::get, Rarity.RARE, 1);
    public static final DeferredItem<Item> NEKO_SPAWN = registerItem(LovelyIdentifier.NEKO_SPAWN, LovelyEntities.NEKO::get, Rarity.RARE, 1);
    public static final DeferredItem<Item> VANILLA_SPAWN = registerItem(LovelyIdentifier.VANILLA_SPAWN, LovelyEntities.VANILLA::get, Rarity.RARE, 1);
