...
/**
 * NeoForge wrapper for headphone overlay layer rendering.
 * <p>
...
public class HeadphoneOverlayLayer<T extends LovelyRobotEntity & GeoEntity> implements IInternalRenderLayer<T> {
    ...
    /**
     * Creates NeoForge headphone overlay layer wrapper.
     *
    ...
    public HeadphoneOverlayLayer(GeoRenderer<T> renderer, ResourceLocation defaultTexture) {
        ...
        this.commonLayer = new net.msymbios.llovelyr.lib.rendering.HeadphoneOverlayLayer<>(defaultTexture.toString());
