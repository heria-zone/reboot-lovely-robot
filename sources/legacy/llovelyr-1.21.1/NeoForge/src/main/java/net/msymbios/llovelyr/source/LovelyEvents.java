 ...
 * (server-only events).
 */
@EventBusSubscriber(modid = LovelyConstant.MODID, bus = EventBusSubscriber.Bus.MOD)
public class LovelyEvents {
     ...
     */
    @EventBusSubscriber(modid = LovelyConstant.MODID, bus = EventBusSubscriber.Bus.GAME)
     ...
     * gameplay events).
     */
    @EventBusSubscriber(modid = LovelyConstant.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.DEDICATED_SERVER)
     ...
     */
    @EventBusSubscriber(modid = LovelyConstant.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
