...
public class LegacyRecipes {
    ...
    public static final RegistryObject<LegacySpawnRecipeSerializer> SPAWN_EGG_CRAFTING = RECIPE_SERIALIZERS.register("lovely_spawn", () -> new LegacySpawnRecipeSerializer(LegacyItems.ROBOT_CORE.get()));
    public static final RegistryObject<LegacySpawnDyeRecipeSerializer> SPAWN_EGG_DYE = RECIPE_SERIALIZERS.register("lovely_spawn_dye", LegacySpawnDyeRecipeSerializer::new);
