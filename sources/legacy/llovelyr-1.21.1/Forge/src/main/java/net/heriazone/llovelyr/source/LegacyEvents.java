...
public class LegacyEvents {
     ...
     */
    @Mod.EventBusSubscriber(modid = Legacy.MODID, bus = Mod.EventBusSubscriber.Bus.FORGE)
    public static class ForgeEvents {
        ...
        public static void onRegisterCommands(RegisterCommandsEvent event) {
            ...
            Legacy.LOGGER.info("Registered NativeRobotEntity commands");
        } // onRegisterCommands()
     ...
     * gameplay events).
     */
    @Mod.EventBusSubscriber(modid = Legacy.MODID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.DEDICATED_SERVER)
     ...
     */
    @Mod.EventBusSubscriber(modid = Legacy.MODID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
