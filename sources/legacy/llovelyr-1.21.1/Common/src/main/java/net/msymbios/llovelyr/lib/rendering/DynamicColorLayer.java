 ...
 */
public class DynamicColorLayer<T extends LovelyRobotEntity> implements IInternalRenderLayer<T> {

    // -- Fields --

    private final String maskTexturePath;
    private final Function<LovelyRobotEntity, Integer> colorProvider;
    private final Predicate<LovelyRobotEntity> renderCondition;
     ...
     * @param renderCondition predicate determining if layer should render
     */
    public DynamicColorLayer(String maskTexturePath, Function<LovelyRobotEntity, Integer> colorProvider, Predicate<LovelyRobotEntity> renderCondition) {
    ...
    public LayerRenderContext getRenderContext(T entity, float partialTick) {
        ...
        if (maskTexturePath != null && !maskTexturePath.isEmpty()) {
            texture = net.minecraft.resources.ResourceLocation.parse(maskTexturePath);
        }
