package net.msymbios.llovelyr.lib.items.base;
...
import net.msymbios.llovelyr.lib.items.helpers.ItemInteractionHelper;
...
public abstract class BaseSpawnItem {
    ...
    public boolean validateSpawnItem(ItemStack itemStack) {
        return net.msymbios.llovelyr.lib.utils.ItemSpawnHelper.validateSpawnItem(itemStack);
    } // validateSpawnItem()
    ...
    public boolean isValidSpawnItem(ItemStack itemStack) {
        return net.msymbios.llovelyr.lib.utils.ItemSpawnHelper.isValidSpawnItem(itemStack);
    } // isValidSpawnItem()
