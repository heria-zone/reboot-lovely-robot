...
public class PickupFeature {
    ...
    private final Function<InternalEntity, CompoundTag> nbtPackager;
     ...
     */
    public PickupFeature(@NotNull Item pickupItem, @NotNull Function<InternalEntity, CompoundTag> nbtPackager) {
     ...
     */
    public ItemStack createPickupItem(@NotNull InternalEntity entity) {
     ...
     */
    public void applyPickupData(@NotNull ItemStack stack, @NotNull InternalEntity entity) {
     ...
     */
    private static CompoundTag defaultNbtPackager(@NotNull InternalEntity entity) {
