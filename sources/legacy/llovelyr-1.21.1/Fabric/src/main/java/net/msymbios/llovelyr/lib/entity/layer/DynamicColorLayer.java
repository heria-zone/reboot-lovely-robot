...
/**
 * Fabric wrapper for dynamic color layer rendering.
 * <p>
...
public class DynamicColorLayer<T extends LovelyRobotEntity & GeoEntity> implements IInternalRenderLayer<T> {
    ...
    private final net.msymbios.llovelyr.lib.rendering.DynamicColorLayer commonLayer;
    ...
    public DynamicColorLayer(GeoRenderer<T> renderer, ResourceLocation maskTexture,
        ...
        this.commonLayer = new net.msymbios.llovelyr.lib.rendering.DynamicColorLayer(
