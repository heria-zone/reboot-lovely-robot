...
import net.msymbios.llovelyr.lib.items.base.BaseSpawnItem;
import org.jetbrains.annotations.Nullable;

import java.util.List;

/**
 * Fabric spawn egg for summoning robots with component-stored customization.
 * <p>
 ...
 * common behavior while maintaining Fabric-specific inheritance requirements.
...
public class LovelySpawnItem extends SpawnEggItem {
    ...
    public LovelySpawnItem(EntityType<? extends Mob> type, Item.Properties properties) {
    ...
    /**
     * Delegate class that extends BaseSpawnItem to provide Fabric-specific implementations.
     * <p>
