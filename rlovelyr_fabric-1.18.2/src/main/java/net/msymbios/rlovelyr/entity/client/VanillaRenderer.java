...
public class VanillaRenderer extends GeoEntityRenderer<VanillaEntity> {
    ...
    @Override
    public RenderLayer getRenderType(VanillaEntity instance, float partialTick, MatrixStack poseStack, @org.jetbrains.annotations.Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, Identifier texture) {
