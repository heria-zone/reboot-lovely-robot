...
public class HoneyRenderer extends GeoEntityRenderer<HoneyEntity> {
    ...
    @Override
    public RenderLayer getRenderType(HoneyEntity instance, float partialTick, MatrixStack poseStack, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, Identifier texture) {
