...
public class HoneyEntity extends TameableEntity implements IAnimatable {
    ...
    private <E extends IAnimatable> PlayState locomotionAnim(AnimationEvent<E> event) {
        if(event.isMoving()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.lovelyrobot.walk", true));
            return PlayState.CONTINUE;
        }

        if(isSitting()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.lovelyrobot.sit", true));
            return PlayState.CONTINUE;
        } else {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.lovelyrobot.idle", true));
            return PlayState.CONTINUE;
        }
    } // locomotionAnim ()
    ...
    private <E extends IAnimatable> PlayState attackAnim(AnimationEvent<E> event) {
        if(this.handSwinging && event.getController().getAnimationState().equals(AnimationState.Stopped)) {
            ...
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.lovelyrobot.attack", false));
