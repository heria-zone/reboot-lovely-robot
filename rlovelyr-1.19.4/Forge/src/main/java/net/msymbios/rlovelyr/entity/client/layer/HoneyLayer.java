...
public class HoneyLayer extends GeoRenderLayer<HoneyEntity> {
    ...
    // -- Inherited Methods --
    @Override
    public void render(PoseStack poseStack, HoneyEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
