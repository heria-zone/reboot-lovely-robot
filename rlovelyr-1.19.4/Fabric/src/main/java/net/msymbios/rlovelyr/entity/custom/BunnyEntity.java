...
public class BunnyEntity extends TameableEntity implements GeoEntity {
    ...
    public int getMaxLevel(){
        var value = (int)ModMetrics.getAttributeValue(RobotVariant.Bunny, RobotAttribute.MAX_LEVEL);
        var oldValue = value;
    ...
    public int getAttackValue() {
        var attack = ModMetrics.getAttributeValue(RobotVariant.Bunny, RobotAttribute.ATTACK_DAMAGE);
        return (int)(attack + this.getLevel() * attack / 50);
    } // getAttackValue ()

    public int getDefenseValue() {
        var defense = ModMetrics.getAttributeValue(RobotVariant.Bunny, RobotAttribute.DEFENSE);
