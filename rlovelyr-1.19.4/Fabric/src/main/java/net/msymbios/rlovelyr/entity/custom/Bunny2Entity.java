...
public class Bunny2Entity extends TameableEntity implements GeoEntity {
    ...
    private static final TrackedData<Integer> STATE = DataTracker.registerData(Bunny2Entity.class, TrackedDataHandlerRegistry.INTEGER);
    private static final TrackedData<Boolean> AUTO_ATTACK = DataTracker.registerData(Bunny2Entity.class, TrackedDataHandlerRegistry.BOOLEAN);

    private static final TrackedData<Integer> MAX_LEVEL = DataTracker.registerData(Bunny2Entity.class, TrackedDataHandlerRegistry.INTEGER);
    private static final TrackedData<Integer> LEVEL = DataTracker.registerData(Bunny2Entity.class, TrackedDataHandlerRegistry.INTEGER);
    private static final TrackedData<Integer> EXP = DataTracker.registerData(Bunny2Entity.class, TrackedDataHandlerRegistry.INTEGER);

    private static final TrackedData<Integer> FIRE_PROTECTION = DataTracker.registerData(Bunny2Entity.class, TrackedDataHandlerRegistry.INTEGER);
    private static final TrackedData<Integer> FALL_PROTECTION = DataTracker.registerData(Bunny2Entity.class, TrackedDataHandlerRegistry.INTEGER);
    private static final TrackedData<Integer> BLAST_PROTECTION = DataTracker.registerData(Bunny2Entity.class, TrackedDataHandlerRegistry.INTEGER);
    private static final TrackedData<Integer> PROJECTILE_PROTECTION = DataTracker.registerData(Bunny2Entity.class, TrackedDataHandlerRegistry.INTEGER);

    private static final TrackedData<Float> BASE_X = DataTracker.registerData(Bunny2Entity.class, TrackedDataHandlerRegistry.FLOAT);
    private static final TrackedData<Float> BASE_Y = DataTracker.registerData(Bunny2Entity.class, TrackedDataHandlerRegistry.FLOAT);
    private static final TrackedData<Float> BASE_Z = DataTracker.registerData(Bunny2Entity.class, TrackedDataHandlerRegistry.FLOAT);;
