...
public class LovelyRobotID {
    ...
    public static MutableText getTranslation(EntityTexture texture) {
        MutableText value = getMessageTranslation(LovelyRobotID.TEX_PINK);
        switch (texture) {
    ...
    public static MutableText getTranslation(final String category, final String key) {
        return Text.translatable(category + LovelyRobot.MODID + "." + key);
    } // getTranslation ()
    ...
    public static MutableText getTranslation(final String category, final String key, Object... objects) {
        return Text.translatable(category + LovelyRobot.MODID + "." + key, objects);
    } // getTranslation ()

    public static Identifier getId(final String path) {
        return Identifier.of(LovelyRobot.MODID, path);
    } // getId ()
