...
public class AIRangedAttackGoal<T extends MobEntity & RangedAttackMob> extends Goal {
    ...
    public AIRangedAttackGoal(T actor, double speed, int attackInterval, float range) {
        this.actor = actor;
        this.speed = speed;
