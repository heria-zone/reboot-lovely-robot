...
public class HoneyEntity extends TamableAnimal implements NeutralMob, VariantHolder<RobotVariant>, GeoEntity {
    ...
    public static AttributeSupplier setAttributes() {
        return Animal.createMobAttributes()
                ...
                .add(Attributes.MOVEMENT_SPEED, ModMetrics.HoneyMovementSpeed).build();
    } // setAttributes ()
