...
public class VanillaEntity extends TamableAnimal implements VariantHolder<RobotVariant>, GeoEntity {
    ...
    // -- Initialize --
    static {
        TEXTURES.put(0, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/vanilla/vanilla_00.png"));
        TEXTURES.put(1, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/vanilla/vanilla_01.png"));
        TEXTURES.put(2, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/vanilla/vanilla_02.png"));
        TEXTURES.put(3, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/vanilla/vanilla_03.png"));

        MODELS.put("normal", new ResourceLocation(LovelyRobotMod.MODID, "geo/vanilla.geo.json"));

        ANIMATIONS.put("locomotion", new ResourceLocation(LovelyRobotMod.MODID, "animations/lovelyrobot.animation.json"));

        VARIANT = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.INT);
        MODE = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.INT);
        AUTO_ATTACK = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.BOOLEAN);
    }
