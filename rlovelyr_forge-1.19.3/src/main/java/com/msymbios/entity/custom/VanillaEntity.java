...
public class VanillaEntity extends TamableAnimal implements NeutralMob, VariantHolder<RobotVariant>, GeoEntity {
    ...
    // -- Initialize --
    static {
        TEXTURES.put(7, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/vanilla/vanilla_01.png")); // Orange
        TEXTURES.put(9, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/vanilla/vanilla_02.png")); // Magenta
        TEXTURES.put(1, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/vanilla/vanilla_04.png")); // Yellow
        TEXTURES.put(8, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/vanilla/vanilla_05.png")); // Lime
        TEXTURES.put(0, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/vanilla/vanilla_06.png")); // Pink
        TEXTURES.put(2, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/vanilla/vanilla_08.png")); // Light Blue
        TEXTURES.put(4, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/vanilla/vanilla_10.png")); // Purple
        TEXTURES.put(6, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/vanilla/vanilla_11.png")); // Blue
        TEXTURES.put(5, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/vanilla/vanilla_14.png")); // Red
        TEXTURES.put(3, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/vanilla/vanilla_15.png")); // Black

        MODELS.put("unarmed", new ResourceLocation(LovelyRobotMod.MODID, "geo/honey.geo.json"));
    ...
    public void setTexture(ItemStack itemStack) {
        if(itemStack.is(Items.ORANGE_DYE)) setVariant(RobotVariant.ORANGE);
        if(itemStack.is(Items.MAGENTA_DYE)) setVariant(RobotVariant.MAGENTA);
        if(itemStack.is(Items.YELLOW_DYE)) setVariant(RobotVariant.YELLOW);
        if(itemStack.is(Items.LIME_DYE)) setVariant(RobotVariant.LIME);
        ...
        if(itemStack.is(Items.BLUE_DYE)) setVariant(RobotVariant.BLUE);
        if(itemStack.is(Items.RED_DYE)) setVariant(RobotVariant.RED);
        if(itemStack.is(Items.BLACK_DYE)) setVariant(RobotVariant.BLACK);
    } // setTexture ()
    ...
    public static AttributeSupplier setAttributes() {
        return Animal.createMobAttributes()
                ...
                .add(Attributes.MOVEMENT_SPEED, ModMetrics.VanillaMovementSpeed).build();
    } // setAttributes ()
