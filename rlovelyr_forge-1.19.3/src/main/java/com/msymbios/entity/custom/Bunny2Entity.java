...
public class Bunny2Entity extends TamableAnimal implements NeutralMob, VariantHolder<RobotVariant>, GeoEntity {
    ...
    static {
        ...
        MODELS.put("unarmed", new ResourceLocation(LovelyRobotMod.MODID, "geo/bunny2.geo.json"));
    ...
    public static AttributeSupplier setAttributes() {
        return Animal.createMobAttributes()
                ...
                .add(Attributes.MOVEMENT_SPEED, ModMetrics.Bunny2MovementSpeed).build();
    } // setAttributes ()
