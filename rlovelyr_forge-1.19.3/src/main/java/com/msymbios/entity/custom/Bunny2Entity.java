...
public class Bunny2Entity extends TamableAnimal implements VariantHolder<RobotVariant>, GeoEntity {
    ...
    // -- Initialize --
    static {
        TEXTURES.put(0, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/bunny2/bunny2_00.png"));
        TEXTURES.put(6, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/bunny2/bunny2_01.png"));
        TEXTURES.put(8, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/bunny2/bunny2_02.png"));
        TEXTURES.put(7, new ResourceLocation(LovelyRobotMod.MODID, "textures/entity/bunny2/bunny2_03.png"));

        MODELS.put("normal", new ResourceLocation(LovelyRobotMod.MODID, "geo/bunny2.geo.json"));
        ...
        VARIANT = SynchedEntityData.defineId(Bunny2Entity.class, EntityDataSerializers.INT);
        MODE = SynchedEntityData.defineId(Bunny2Entity.class, EntityDataSerializers.INT);
        AUTO_ATTACK = SynchedEntityData.defineId(Bunny2Entity.class, EntityDataSerializers.BOOLEAN);
    }
