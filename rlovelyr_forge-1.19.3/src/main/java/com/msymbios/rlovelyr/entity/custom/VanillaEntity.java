...
import static com.msymbios.rlovelyr.item.ModItems.ROBOT_CORE;
...
public class VanillaEntity extends TamableAnimal implements NeutralMob, GeoEntity {
    ...
    private static final EntityDataAccessor<Integer> STATE = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> AUTO_ATTACK = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.BOOLEAN);

    private static final EntityDataAccessor<Integer> MAX_LEVEL = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> LEVEL = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> EXP = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.INT);

    private static final EntityDataAccessor<Integer> FIRE_PROTECTION = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> FALL_PROTECTION = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> BLAST_PROTECTION = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> PROJECTILE_PROTECTION = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.INT);

    private static final EntityDataAccessor<Float> BASE_X = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> BASE_Y = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> BASE_Z = SynchedEntityData.defineId(VanillaEntity.class, EntityDataSerializers.FLOAT);
    ...
    public int getHpValue() {
        return (int)(ModMetrics.VanillaBaseHp + this.getBaseLevel() * ModMetrics.VanillaBaseHp / 50);
    } // getHpValue ()

    public int getAttackValue() {
        return (int)(ModMetrics.VanillaBaseAttack + this.getBaseLevel() * ModMetrics.VanillaBaseAttack / 50);
    } // getAttackValue ()

    public int getDefenseValue() {
        return (int)(ModMetrics.VanillaBaseDefense + this.getBaseLevel() * ModMetrics.VanillaBaseDefense / 50);
    } // getDefenseValue ()
