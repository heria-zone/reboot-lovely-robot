...
public class BunnyEntity extends InternalEntity implements IAngerable, IAnimatable {
    ...
    public static AttributeModifierMap  setAttributes() {
        return MobEntity.createMobAttributes()
                .add(Attributes.MAX_HEALTH, InternalMetric.getAttribute(EntityVariant.Bunny, EntityAttribute.MAX_HEALTH))
                .add(Attributes.ATTACK_DAMAGE, InternalMetric.getAttribute(EntityVariant.Bunny, EntityAttribute.ATTACK_DAMAGE))
                .add(Attributes.ATTACK_SPEED, InternalMetric.getAttribute(EntityVariant.Bunny, EntityAttribute.ATTACK_SPEED))
                .add(Attributes.MOVEMENT_SPEED, InternalMetric.getAttribute(EntityVariant.Bunny, EntityAttribute.MOVEMENT_SPEED))
                .add(Attributes.ARMOR, InternalMetric.getAttribute(EntityVariant.Bunny, EntityAttribute.ARMOR))
                .add(Attributes.ARMOR_TOUGHNESS, InternalMetric.getAttribute(EntityVariant.Bunny, EntityAttribute.ARMOR_TOUGHNESS)).build();
    } // setAttributes ()

    // -- Constructor --
    public BunnyEntity(EntityType<? extends TameableEntity> entityType, World level) {
