...
public class VanillaLayer extends GeoLayerRenderer<VanillaEntity> {
    ...
    // -- Inherited Methods --
    @Override
    public void render(MatrixStack poseStack, IRenderTypeBuffer bufferSource, int packedLightIn, VanillaEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
