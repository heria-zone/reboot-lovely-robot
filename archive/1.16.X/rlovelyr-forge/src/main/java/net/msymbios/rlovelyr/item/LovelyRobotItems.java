...
public class LovelyRobotItems {
    ...
    public static final RegistryObject<Item> ROBOT_CORE = ITEMS.register(LovelyRobotID.ROBOT_CORE, () -> new RobotCoreItem(new Item.Properties().tab(LovelyRobotItemsGroup.LOVELY_ROBOT).rarity(Rarity.UNCOMMON)));
