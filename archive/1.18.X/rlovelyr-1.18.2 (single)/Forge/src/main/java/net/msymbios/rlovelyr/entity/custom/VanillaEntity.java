...
public class VanillaEntity extends InternalEntity implements IAnimatable {
    ...
    public VanillaEntity(EntityType<? extends TamableAnimal> entityType, Level level) {
        ...
        this.nativeEntity = NativeEntity.VANILLA;
    ...
    public static AttributeSupplier createAttributes() {
        return Animal.createMobAttributes()
                .add(Attributes.MAX_HEALTH, NativeEntity.VANILLA.getMaxHealth())
                .add(Attributes.ATTACK_DAMAGE, NativeEntity.VANILLA.getAttackDamage())
                .add(Attributes.ATTACK_SPEED, NativeEntity.VANILLA.getAttackSpeed())
                .add(Attributes.MOVEMENT_SPEED, NativeEntity.VANILLA.getMoveSpeed())
                .add(Attributes.ARMOR, NativeEntity.VANILLA.getArmour())
                .add(Attributes.ARMOR_TOUGHNESS, NativeEntity.VANILLA.getArmourToughness())
                .build();
    } // createAttributes ()
