...
public class Bunny2Entity extends InternalEntity implements IAnimatable {
    ...
    public Bunny2Entity(EntityType<? extends TamableAnimal> entityType, Level level) {
        ...
        this.nativeEntity = NativeEntity.BUNNY2;
    ...
    public static AttributeSupplier createAttributes() {
        return Animal.createMobAttributes()
                .add(Attributes.MAX_HEALTH, NativeEntity.BUNNY2.getMaxHealth())
                .add(Attributes.ATTACK_DAMAGE, NativeEntity.BUNNY2.getAttackDamage())
                .add(Attributes.ATTACK_SPEED, NativeEntity.BUNNY2.getAttackSpeed())
                .add(Attributes.MOVEMENT_SPEED, NativeEntity.BUNNY2.getMoveSpeed())
                .add(Attributes.ARMOR, NativeEntity.BUNNY2.getArmour())
                .add(Attributes.ARMOR_TOUGHNESS, NativeEntity.BUNNY2.getArmourToughness())
                .build();
    } // createAttributes ()
