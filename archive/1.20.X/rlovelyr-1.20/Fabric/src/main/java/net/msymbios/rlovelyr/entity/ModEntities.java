...
public class ModEntities {
    ...
    public static final EntityType<BunnyEntity> BUNNY = Registry.register(Registries.ENTITY_TYPE, new Identifier(LovelyRobotMod.MODID, "bunny"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, BunnyEntity::new).dimensions(EntityDimensions.fixed(InternalMetric.Width, InternalMetric.Width)).build());
    public static final EntityType<Bunny2Entity> BUNNY2 = Registry.register(Registries.ENTITY_TYPE, new Identifier(LovelyRobotMod.MODID, "bunny2"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, Bunny2Entity::new).dimensions(EntityDimensions.fixed(InternalMetric.Width, InternalMetric.Width)).build());
    public static final EntityType<HoneyEntity> HONEY = Registry.register(Registries.ENTITY_TYPE, new Identifier(LovelyRobotMod.MODID, "honey"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, HoneyEntity::new).dimensions(EntityDimensions.fixed(InternalMetric.Width, InternalMetric.Width)).build());
    public static final EntityType<VanillaEntity> VANILLA = Registry.register(Registries.ENTITY_TYPE, new Identifier(LovelyRobotMod.MODID, "vanilla"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, VanillaEntity::new).dimensions(EntityDimensions.fixed(InternalMetric.Width, InternalMetric.Width)).build());
