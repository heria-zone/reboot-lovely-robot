...
public class StatControl extends Control {
     ...
     */
    public StatControl(Texture iconTexture, Supplier<String> valueSupplier, Supplier<List<Component>> tooltipSupplier, boolean renderValueToLeftOfIcon) {
        super();
    ...
    @Override
    public void onTick() {
        valueControl.setText(Component.literal(valueSupplier.get()).getString());
    }
