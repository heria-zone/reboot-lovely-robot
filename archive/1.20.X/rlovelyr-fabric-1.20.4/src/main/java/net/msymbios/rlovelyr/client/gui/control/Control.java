...
import net.msymbios.rlovelyr.client.gui.control.event.events.TryDragEvent;
import net.msymbios.rlovelyr.client.gui.control.event.events.TryHoverEvent;
...
public class Control extends BaseControl {
     ...
     */
    public void renderTooltip(double mouseX, double mouseY, Component tooltip) {
     ...
     * @param mouseY    the mouse y position.
     */
    public void renderTooltip(List<? extends Component> tooltip, double mouseX, double mouseY) {
        Minecraft.getInstance().screen.renderWithTooltip(tooltip.stream().map(Component::getVisualOrderText).collect(Collectors.toList()), (int) (mouseX / getPixelScaleX()), (int) (mouseY / getPixelScaleY()));
    } // renderTooltip ()
     ...
     * @param tooltip   the tooltip to render.
     */
    public void renderTooltip(double mouseX, double mouseY, List<FormattedCharSequence> tooltip) {
        Minecraft.getInstance().screen.renderWithTooltip(tooltip, (int) (mouseX / getPixelScaleX()), (int) (mouseY / getPixelScaleY()));
    } // renderTooltip ()
