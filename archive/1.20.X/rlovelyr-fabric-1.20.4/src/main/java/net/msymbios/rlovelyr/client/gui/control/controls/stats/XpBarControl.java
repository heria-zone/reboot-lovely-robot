...
public class XpBarControl extends Control {
    ...
    public void onRenderTooltip(double mouseX, double mouseY, float partialTicks) {
        ...
        tooltip.add(Component.literal(String.valueOf(blockling.getStats().getLevelAttribute(this.level).displayStringNameSupplier.get())).withStyle(ChatFormatting.GOLD));
        tooltip.add(LovelyRobotID.getTranslation("gui.current_level").withStyle(ChatFormatting.GRAY).append(String.valueOf(level.getValue())).withStyle(ChatFormatting.WHITE));
