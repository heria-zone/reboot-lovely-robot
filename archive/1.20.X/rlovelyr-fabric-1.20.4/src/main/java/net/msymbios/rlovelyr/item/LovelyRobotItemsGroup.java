...
public class LovelyRobotItemsGroup {
     ...
     * */
    private static FabricItemGroup register(String name, ItemGroup itemGroup) {
    ...
    private static ItemGroup register(String translatable) {
        ...
        return FabricItemGroup.builder().displayName(Component.translatable(translatable)).icon(() -> new ItemStack(LovelyRobotItems.BUNNY_SPAWN)).entries(((displayContext, entries) -> {
