...
public abstract class ModifiableNumberAttribute<T extends Number> extends ModifiableAttribute<T> {
     ...
     */
    public ModifiableNumberAttribute(String id, String key, InterfaceEntity blockling, T initialBaseValue, @Nullable Function<T, String> displayStringValueFunction, @Nullable Supplier<String> displayStringNameSupplier, boolean isEnabled, IModifier<T>... modifiers) {
    ...
    @Nullable
    public
EntityAttribute getVanillaAttribute() {
     ...
     */
    public void setVanillaAttribute(@Nullable
    ...
    protected void updateVanillaAttribute() {
        ...
        if (this instanceof IModifier) {
            ...
            if (isEnabled()) {
                ...
                vanillaAttributeInstance.addPersistentModifier(new EntityAttributeModifier(id, key, getValue().doubleValue(), Operation.vanillaOperation(modifier.getOperation())));
            }
        }
...
} // Class ModifiableNumberAttribute