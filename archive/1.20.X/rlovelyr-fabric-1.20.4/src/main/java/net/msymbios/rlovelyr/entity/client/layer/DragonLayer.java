...
public class DragonLayer extends GeoRenderLayer<DragonEntity> {
    ...
    // -- Inherited Methods --
    @Override
    public void render(MatrixStack poseStack, DragonEntity animatable, BakedGeoModel bakedModel, RenderLayer renderType, VertexConsumerProvider bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
