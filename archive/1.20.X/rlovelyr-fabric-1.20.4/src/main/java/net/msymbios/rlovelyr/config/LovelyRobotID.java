...
public class LovelyRobotID {
    ...
    // MESSAGES
    public static final ResourceLocation NET_MESSAGE_ENABLED = getId("net_message.is_enabled");
    public static final ResourceLocation NET_MESSAGE_ENUM_ATTRIBUTE = getId("net_message.enum_attribute");
    public static final ResourceLocation NET_MESSAGE_FLOAT_VALUE = getId("net_message.float_value");
    public static final ResourceLocation NET_MESSAGE_MODIFIABLE_FLOAT = getId("net_message.modifiable_float_base_value");
    public static final ResourceLocation NET_MESSAGE_INT_VALUE = getId("net_message.int_value");
    public static final ResourceLocation NET_MESSAGE_MODIFIABLE_INT = getId("net_message.modifiable_int_base_value");

    public static final ResourceLocation NET_MESSAGE_NAME = getId("net_message.name");
     ...
     */
    public static MutableComponent getAttributeTranslation(final String key, Object... objects) {
     ...
     */
    public static MutableComponent getSkillTranslation(final String key) {
