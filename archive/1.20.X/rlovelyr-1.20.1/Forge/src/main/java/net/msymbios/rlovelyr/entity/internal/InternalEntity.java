...
public abstract class InternalEntity extends TamableAnimal {
    ...
    public void FollowState(ItemStack stack){
        if(!canInteract(stack)) return;
    ...
    public void displayEnchantmentMessage () {
        ...
        InternalLogic.commandDebug(this, Component.translatable("msg.rlovelyr.looting").append(": " + this.getLooting()                             + "/" + InternalMetric.MAX_LOOT_ENCHANTMENT), false);
        InternalLogic.commandDebug(this, Component.translatable("msg.rlovelyr.fire_protection").append(": " + this.getFireProtection()              + "/" + InternalMetric.PROTECTION_LIMIT_FIRE), false);
        InternalLogic.commandDebug(this, Component.translatable("msg.rlovelyr.fall_protection").append(": " + this.getFallProtection()              + "/" + InternalMetric.PROTECTION_LIMIT_FALL), false);
        InternalLogic.commandDebug(this, Component.translatable("msg.rlovelyr.blast_protection").append(": " + this.getBlastProtection()            + "/" + InternalMetric.PROTECTION_LIMIT_BLAST), false);
        InternalLogic.commandDebug(this, Component.translatable("msg.rlovelyr.projectile_protection").append(": " + this.getProjectileProtection()  + "/" + InternalMetric.PROTECTION_LIMIT_PROJECTILE), false);
