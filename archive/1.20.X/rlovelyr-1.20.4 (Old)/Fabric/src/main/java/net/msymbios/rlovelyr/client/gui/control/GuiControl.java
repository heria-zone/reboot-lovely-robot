...
public abstract class GuiControl implements HudRenderingEntrypoint {
     ...
     */
    protected void renderShadowedText(Text text, int colour) {
     ...
     * @param colour    the colour of the text.
     */
    protected void renderText(Text text, int colour) {
     ...
     */
    public void renderTooltip(double mouseX, double mouseY, double pixelScaleX, double pixelScaleY, Text tooltip) {
     ...
     * @param tooltip     the tooltip to render.
     */
    public void renderTooltip(double mouseX, double mouseY, double pixelScaleX, double pixelScaleY, List<Text> tooltip) {
        mc.currentScreen.renderWithTooltip(matrices, tooltip, (int) (mouseX / pixelScaleX), (int) (mouseY / pixelScaleY));
    } // renderTooltip ()
