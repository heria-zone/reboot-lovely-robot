...
public class KitsuneLayer extends GeoLayerRenderer<KitsuneEntity> {
    ...
    // -- Inherited Methods --
    @Override
    public void render(PoseStack poseStack, MultiBufferSource bufferSource, int packedLightIn, KitsuneEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
