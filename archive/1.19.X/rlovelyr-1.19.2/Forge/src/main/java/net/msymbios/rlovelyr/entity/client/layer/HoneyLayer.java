...
public class HoneyLayer extends GeoLayerRenderer<HoneyEntity> {
    ...
    // -- Inherited Methods --
    @Override
    public void render(PoseStack poseStack, MultiBufferSource bufferSource, int packedLightIn, HoneyEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
