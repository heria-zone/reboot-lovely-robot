...
public class Bunny2Entity extends TameableEntity implements VariantHolder<RobotTexture>, GeoEntity {
    ...
    // -- Initialize --
    static {
        TEXTURES.put(RobotTexture.ORANGE.getId(),     new Identifier(LovelyRobotMod.MODID, "textures/entity/bunny2/bunny2_01.png")); // Orange
        TEXTURES.put(RobotTexture.MAGENTA.getId(),    new Identifier(LovelyRobotMod.MODID, "textures/entity/bunny2/bunny2_02.png")); // Magenta
        TEXTURES.put(RobotTexture.YELLOW.getId(),     new Identifier(LovelyRobotMod.MODID, "textures/entity/bunny2/bunny2_04.png")); // Yellow
        TEXTURES.put(RobotTexture.LIME.getId(),       new Identifier(LovelyRobotMod.MODID, "textures/entity/bunny2/bunny2_05.png")); // Lime
        TEXTURES.put(RobotTexture.PINK.getId(),       new Identifier(LovelyRobotMod.MODID, "textures/entity/bunny2/bunny2_06.png")); // Pink
        TEXTURES.put(RobotTexture.LIGHT_BLUE.getId(), new Identifier(LovelyRobotMod.MODID, "textures/entity/bunny2/bunny2_08.png")); // Light Blue
        TEXTURES.put(RobotTexture.PURPLE.getId(),     new Identifier(LovelyRobotMod.MODID, "textures/entity/bunny2/bunny2_10.png")); // Purple
        TEXTURES.put(RobotTexture.BLUE.getId(),       new Identifier(LovelyRobotMod.MODID, "textures/entity/bunny2/bunny2_11.png")); // Blue
        TEXTURES.put(RobotTexture.RED.getId(),        new Identifier(LovelyRobotMod.MODID, "textures/entity/bunny2/bunny2_14.png")); // Red
        TEXTURES.put(RobotTexture.BLACK.getId(),      new Identifier(LovelyRobotMod.MODID, "textures/entity/bunny2/bunny2_15.png")); // Black
        ...
        TEXTURE_ID = DataTracker.registerData(Bunny2Entity.class, TrackedDataHandlerRegistry.INTEGER);
        STATE = DataTracker.registerData(Bunny2Entity.class, TrackedDataHandlerRegistry.INTEGER);
