...
public class HoneyEntity extends TameableEntity implements VariantHolder<RobotTexture>, GeoEntity {
    ...
    // -- Initialize --
    static {
        TEXTURES.put(RobotTexture.ORANGE.getId(),     new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_01.png")); // Orange
        TEXTURES.put(RobotTexture.MAGENTA.getId(),    new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_02.png")); // Magenta
        TEXTURES.put(RobotTexture.YELLOW.getId(),     new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_04.png")); // Yellow
        TEXTURES.put(RobotTexture.LIME.getId(),       new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_05.png")); // Lime
        TEXTURES.put(RobotTexture.PINK.getId(),       new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_06.png")); // Pink
        TEXTURES.put(RobotTexture.LIGHT_BLUE.getId(), new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_08.png")); // Light Blue
        TEXTURES.put(RobotTexture.PURPLE.getId(),     new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_10.png")); // Purple
        TEXTURES.put(RobotTexture.BLUE.getId(),       new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_11.png")); // Blue
        TEXTURES.put(RobotTexture.RED.getId(),        new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_14.png")); // Red
        TEXTURES.put(RobotTexture.BLACK.getId(),      new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_15.png")); // Black
        ...
        TEXTURE_ID = DataTracker.registerData(HoneyEntity.class, TrackedDataHandlerRegistry.INTEGER);
        STATE = DataTracker.registerData(HoneyEntity.class, TrackedDataHandlerRegistry.INTEGER);
        AUTO_ATTACK = DataTracker.registerData(HoneyEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    }
