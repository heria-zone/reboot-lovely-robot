...
public class HoneyEntity extends TameableEntity implements GeoEntity {
    ...
    private static final HashMap<Integer, Identifier> TEXTURES = new HashMap<>(){{
        put(RobotTexture.ORANGE.getId(),     new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_01.png")); // Orange
        put(RobotTexture.MAGENTA.getId(),    new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_02.png")); // Magenta
        put(RobotTexture.YELLOW.getId(),     new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_04.png")); // Yellow
        put(RobotTexture.LIME.getId(),       new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_05.png")); // Lime
        put(RobotTexture.PINK.getId(),       new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_06.png")); // Pink
        put(RobotTexture.LIGHT_BLUE.getId(), new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_08.png")); // Light Blue
        put(RobotTexture.PURPLE.getId(),     new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_10.png")); // Purple
        put(RobotTexture.BLUE.getId(),       new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_11.png")); // Blue
        put(RobotTexture.RED.getId(),        new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_14.png")); // Red
        put(RobotTexture.BLACK.getId(),      new Identifier(LovelyRobotMod.MODID, "textures/entity/honey/honey_15.png")); // Black
    }};
    private static final HashMap<String, Identifier> MODELS = new HashMap<>(){{
        put(RobotModel.Unarmed.getName(), new Identifier(LovelyRobotMod.MODID, "geo/honey.geo.json"));
        put(RobotModel.Armed.getName(), new Identifier(LovelyRobotMod.MODID, "geo/honey.attack.geo.json"));
    }};
    ...
    public static DefaultAttributeContainer.Builder setAttributes() {
        return MobEntity.createMobAttributes()
                .add(EntityAttributes.GENERIC_MAX_HEALTH, ModMetrics.HoneyBaseHp)
                .add(EntityAttributes.GENERIC_ATTACK_DAMAGE, ModMetrics.HoneyBaseAttack)
                .add(EntityAttributes.GENERIC_ATTACK_SPEED, ModMetrics.AttackMoveSpeed)
                .add(EntityAttributes.GENERIC_MOVEMENT_SPEED, ModMetrics.HoneyMovementSpeed)
    ...
    public int getHpValue() {
        return (int)(ModMetrics.HoneyBaseHp + this.getLevel() * ModMetrics.HoneyBaseHp / 50);
    } // getHpValue ()

    public int getAttackValue() {
        return (int)(ModMetrics.HoneyBaseAttack + this.getLevel() * ModMetrics.HoneyBaseAttack / 50);
    } // getAttackValue ()

    public int getDefenseValue() {
        return (int)(ModMetrics.HoneyBaseDefense + this.getLevel() * ModMetrics.HoneyBaseDefense / 50);
    } // getDefenseValue ()
