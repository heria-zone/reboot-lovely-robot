...
public class Utility {
    ...
    public static void addTypeTooltip(List<Component> tooltip, CompoundTag nbt) {
        ...
        if (!type.isEmpty()) tooltip.add(Component.translatable(LovelyRobotID.TRANS_MSG_TYPE).append(Component.nullToEmpty(": ")).withStyle(defaultFormatting).append(Component.translatable(type).withStyle(textFormatting)));
    } // addTypeTooltip ()
    ...
    public static void addColorTooltip(List<Component> tooltip, CompoundTag nbt) {
        ...
        tooltip.add(Component.translatable(LovelyRobotID.TRANS_MSG_COLOR).append(Component.nullToEmpty(": ")).withStyle(defaultFormatting).append(Component.translatable(LovelyRobotID.getTranslation(texture)).withStyle(textFormatting)));
    } // appendTooltip ()
    ...
    public static void addLevelTooltip(List<Component> tooltip, CompoundTag nbt) {
        ...
        if(level > 0) tooltip.add(Component.translatable(LovelyRobotID.TRANS_MSG_LEVEL).append(Component.nullToEmpty(": ")).withStyle(defaultFormatting).append(Component.nullToEmpty("" + level)).withStyle(textFormatting));
    } // appendTooltip ()
