...
public class VanillaEntity extends InternalRobot implements GeoEntity {
    ...
    // TEXTURE
    @Override
    public Identifier getTextureByID(int value) { return ModMetrics.getTexture(RobotVariant.Vanilla, RobotTexture.byId(value)); } // getTextureByID ()

    // VARIANT
    @Override
    public String getVariant() {
        return this.getVariant(RobotVariant.Vanilla.getName());
    } // getVariant ()

    // STATS
    @Override
    public int getMaxLevel(){ return getMaxLevel ((int)ModMetrics.getAttributeValue(RobotVariant.Vanilla, RobotAttribute.MAX_LEVEL)); } // getMaxLevel ()
    ...
    public int getHpValue() {
        return getHpValue((int)ModMetrics.getAttributeValue(RobotVariant.Vanilla, RobotAttribute.MAX_HEALTH));
    } // getHpValue ()

    @Override
    public int getAttackValue() {
        return getAttackValue((int)ModMetrics.getAttributeValue(RobotVariant.Vanilla, RobotAttribute.ATTACK_DAMAGE));
    } // getAttackValue ()

    @Override
    public int getDefenseValue() {
        return getDefenseValue((int)ModMetrics.getAttributeValue(RobotVariant.Vanilla, RobotAttribute.DEFENSE));
    } // getDefenseValue ()
