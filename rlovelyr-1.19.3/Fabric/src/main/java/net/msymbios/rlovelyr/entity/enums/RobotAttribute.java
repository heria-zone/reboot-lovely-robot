...
public enum RobotAttribute implements StringIdentifiable {
    ...
    // -- Variables --
    public static final Codec<RobotAttribute> CODEC = StringIdentifiable.createCodec(RobotAttribute::values);
    private static final IntFunction<RobotAttribute> BY_ID = ValueLists.createIdToValueFunction(RobotAttribute::getId, RobotAttribute.values(), ValueLists.OutOfBoundsHandling.WRAP);;
