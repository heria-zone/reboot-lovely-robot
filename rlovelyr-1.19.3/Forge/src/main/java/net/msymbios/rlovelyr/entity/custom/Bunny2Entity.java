...
public class Bunny2Entity extends TamableAnimal implements NeutralMob, GeoEntity {
    ...
    public static AttributeSupplier setAttributes() {
        return Animal.createMobAttributes()
                .add(Attributes.MAX_HEALTH, ModMetrics.getAttributeValue(RobotVariant.Bunny2, RobotAttribute.MAX_HEALTH))
                .add(Attributes.ATTACK_DAMAGE, ModMetrics.getAttributeValue(RobotVariant.Bunny2, RobotAttribute.ATTACK_DAMAGE))
                .add(Attributes.ATTACK_SPEED, ModMetrics.getAttributeValue(RobotVariant.Bunny2, RobotAttribute.ATTACK_SPEED))
                .add(Attributes.MOVEMENT_SPEED, ModMetrics.getAttributeValue(RobotVariant.Bunny2, RobotAttribute.MOVEMENT_SPEED))
                .add(Attributes.ARMOR, ModMetrics.getAttributeValue(RobotVariant.Bunny2, RobotAttribute.ARMOR))
                .add(Attributes.ARMOR_TOUGHNESS, ModMetrics.getAttributeValue(RobotVariant.Bunny2, RobotAttribute.ARMOR_TOUGHNESS)).build();
    } // setAttributes ()
    ...
    public int getAttackValue() {
        var attack = (int)ModMetrics.getAttributeValue(RobotVariant.Bunny2, RobotAttribute.ATTACK_DAMAGE);
        return (attack + this.getCurrentLevel() * attack / 50);
    } // getAttackValue ()

    public int getDefenseValue() {
        var defense = (int)ModMetrics.getAttributeValue(RobotVariant.Bunny2, RobotAttribute.DEFENSE);
    ...
    public SpawnGroupData finalizeSpawn(@NotNull ServerLevelAccessor levelAccessor, @NotNull DifficultyInstance instance, @NotNull MobSpawnType mobSpawnType, @Nullable SpawnGroupData spawnGroupData, @Nullable CompoundTag compoundTag) {
        this.setVariant(RobotVariant.Bunny2.name());
